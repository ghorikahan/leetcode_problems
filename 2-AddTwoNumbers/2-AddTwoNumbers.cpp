// Last updated: 8/27/2026, 10:47:56 PM
/**
...
public:
    ListNode* addTwoNumbers(ListNode* l1, ListNode* l2) {
        ...
        while (temp1 != nullptr || temp2 != nullptr) {
            ...
            // Move pointers to the next nodes in 'l1' and 'l2' if there are
            // remaining nodes
            if (temp1)
                temp1 = temp1->next;
            if (temp2)
        ...
        // If there is a remaining carry after the loop, create a new node with
        // the carry
        if (carry) {
